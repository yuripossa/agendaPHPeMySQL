...
<?php
	...
	echo("Código:$rs[codigo]<br/><br/>
		<label>Nome<br/>
			<input type='hidden' name='codigo' id='codigo' value='$rs[codigo]'>
		...
		}else
		{
			...
			<label>Telefone<br/>
				<input type='text' name='telefone' id='telefone' value='$rs[telefone]' maxlength='13'>
			</label><br/><br/>
			<label>Endereço<br/>
				<input type='text' name='endereco' id='endereco' value='$rs[endereco]'>
			</label><br/><br/>
				<input type = 'submit' name='alterar' id='busca' value='Alterar'/>
